...
public class Sillas_SalaController {
	...
	void click(ActionEvent event) {
		...
		alert.setContentText("Cuesta $" +User_Data.sala.getSilla(numSilla).getPrecio());
		...
		if (result.get() == ButtonType.OK){
			...
			User_Data.silla= User_Data.sala.getSilla(numSilla);
	...
	public void refreshButtons(MouseEvent event) {
		//Activa y desactiva los botones de las sillas, segun si estan ocupadas
		for(Silla silla: User_Data.sala.getSillas()){
